//This lets people pick their preferred color of lights
...
public class ColorActivity extends AppCompatActivity {
    ...
    public void onColorSelected(View view) {
        ...
        intent.putExtra(EXTRA_COLOR, colorId); //user selected an option, putting the selection in the intents extra with the key EXTRA_COLOR
        setResult(RESULT_OK, intent); //this is setting the result, RESULT_OK is a code saying results are being sent. intent holds all the data. like key value
        finish();
    }
}